...
const faqs = [
  ...
  ['What are AI Website Preview Links?', 'AI Website Preview Links turn a business audit into a visual website concept that can be shared with a prospect. They help agencies show what a better online presence could look like instead of only explaining what is missing.'],
  ...
  ['Does LeadScope AI generate outreach messages?', 'Yes. LeadScope AI can generate personalized outreach messages based on the lead, industry, website audit, SEO issues, and recommended service offer.'],
  ...
  ['Are multilingual reports supported?', 'Yes. Public audit reports can be shared in English, Albanian, and Macedonian.'],
  ['Does LeadScope AI replace a CRM?', 'LeadScope AI includes lightweight lead management features such as saved leads, statuses, audits, outreach messages, and preview links. It is designed as a lead-to-pitch workflow tool, not a full enterprise CRM replacement.'],
