    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <header className="sticky top-0 z-30 border-b border-slate-800 bg-slate-950/95 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5"><span className="w-8 h-8 rounded-lg bg-blue-600 grid place-items-center"><Crosshair className="w-4 h-4" /></span><span className="text-white font-bold text-lg">LeadScope <span className="text-blue-400">AI</span></span></div>
      ...
      <main>
        <section className="border-b border-slate-800/80">
          <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 grid lg:grid-cols-[1.05fr_.95fr] gap-14 items-center">
            <div>
              ...
              <h1 className="text-5xl sm:text-6xl font-bold text-white tracking-tight leading-[1.06]">Turn local business leads into client-ready pitches.</h1>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl shadow-black/20 p-5 sm:p-6">
        ...
        <section id="workflow" className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center max-w-2xl mx-auto mb-12"><p className="text-blue-400 text-sm font-semibold uppercase tracking-[0.16em] mb-3">One connected process</p><h2 className="text-3xl sm:text-4xl font-bold text-white">From lead search to client pitch</h2></div>
